  ...
  return (
    <section className="college-project-page">
      ...
      <p className="section-subtitle">
        Academic projects that shaped my journey as a developer
      </p>
      ...
      <div className="project-detail">
        ...
        <img src="/project1.png" alt="Home Maintenance and Service Provider" />
      </div>
      ...
      <div className="project-detail">
        ...
        <img src="/project2.png" alt="NAVIA Campus Guide Robot" />
      </div>
    </section>
  );
}
